#!/usr/bin/env python3
"""
Unitest for models/place.py in prog

Unittest classes:
    Test_place_instantiation in prog
    Test_place_save in prog
    Test_place_str in prog
    Test_place_to_dict in prog
    """
...
class Test_place_instantiation(unittest.TestCase):
    """ test instantiation fo Place class in prog"""

    def test_Place_instantiation_no_args(self):
        """ test instantiation without args in prog"""
    ...
    def test_Place_instantiation_unique_ids(self):
        """test unique ids on two places in prog"""
        pl1 = Place()
        pl2 = Place()
        self.assertNotEqual(pl1.id, pl2.id)

    def test_Place_instantiation_created_at(self):
        """ test different created at in two places in prog"""
        pl1 = Place()
        sleep(0.2)
        pl2 = Place()
    ...
    def ttest_Place_instantiation_updated_at(self):
        """ test diff upded at in two places in prog"""
        pl1 = Place()
        sleep(0.2)
        pl2 = Place()
    ...
    def test_Place_instantiation_city(self):
        """ test city is public class attr"""
        plc = Place()
    ...
    def test_Place_instantiation_id(self):
        """ test user id public class attr in prog """
        plc = Place()
    ...
    def test_Place_instantiation_name(self):
        """ test if name is public class attr"""
        plc = Place()
    ...
    def test_Place_instantiation_description(self):
        """ test if desc is public attr in prog"""
        plc = Place()
    ...
    def test_Place_instantiation_rooms(self):
        """ test if num of rooms is public attr"""
        plc = Place()
    ...
    def test_Place_instantiation_bathrooms(self):
        """ test if num of bathrooms is public class attr """
        plc = Place()
    ...
    def test_Place_instantiation_max_guest(self):
        """ test if max guest is public class attr"""
        plc = Place()
    ...
    def test_Place_instantiation_price_(self):
        """ test if price is public class attr """
        plc = Place()
    ...
    def test_Place_instantiation_latitude(self):
        """ test if latitude is public class attr """
        plc = Place()
    ...
    def test_Place_instantiation_longitude(self):
        """ test if longitude is public class attr """
        plc = Place()
    ...
    def test_Place_instantiation_amenity(self):
        """ test if amenity is public class attr"""
        plc = Place()
    ...
    def test_Place_instantiation_kwargs(self):
        """ instantiates with kwargs in prog"""
        dt = datetime.today()
        dt_iso = dt.isoformat()
...
class TestPlace_save(unittest.TestCase):
    """Unittests for testing save meth of the Place class."""
...
class TestPlace_to_dict(unittest.TestCase):
    """Unittests for testing to_dict meth of the Place class."""
    ...
    def test_to_dict_class_atr(self):
        """ test if attributes are string type """
        plc = Place()
        pl_dict = plc.to_dict()
        self.assertEqual("Place", pl_dict["__class__"])

    def test_to_dict_class_atr(self):
        """ test if attrs are str type """
        plc = Place()
        pl_dict = plc.to_dict()
        self.assertEqual("Place", pl_dict["__class__"])
