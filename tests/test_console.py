...
Unittest classes:
    Test_console_prompt in prog
    Test_console_exit in prog
    Test_console_help in prog
    Test_console_create in prog
    Test_console_show in prog
    Test_console_destroy in prog
    Test_console_all in prog
    Test_console_update in prog
    Test_console_count in prog
    """
...
class Test_console_prompt(unittest.TestCase):
    """test prompting of the comm interpreter in prog"""
...
class Test_console_exit(unittest.TestCase):
    """Unittests for testing exiting from the HBNB comm interpreter in prog."""
